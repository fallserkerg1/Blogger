...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="index.html">Blog Anime</a>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('plantilla/pic/home-back.jpg')">
  ...
  <?php echo $__env->yieldContent('content'); ?><?php /**PATH C:\xampp\htdocs\Blogger\resources\views/layouts/head.blade.php ENDPATH**/ ?>